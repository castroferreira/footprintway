...
const clientID = 'lPgA7jjLSDfDy0rDnh2kgPsUdiwa'
const clientSecret = 'aNJfICP7fgr1cRt5JfBfGHrbTd4a'
...
app.get('/oauth', (req, res) => {
    ...
    axios({
        url: `https://wso2-gw.ua.pt/token?grant_type=authorization_code&code=${requestToken}&schema=openid&redirect_uri=localhost:3000`,
        method: 'POST',
        headers: {
